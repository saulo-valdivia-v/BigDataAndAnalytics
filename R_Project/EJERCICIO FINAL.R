...
### Fecha: todos los grupos deberan entregar el trabajo, como maximo, el primer dia de presentaciones,
#independientemente del dia de su presentacion. De esta forma, 
#todos los grupos tendr?n el mismo tiempo de realizacion del trabajo
### Lugar: Blackboard
### Formato: RMarkdown. Incluir el nombre de los integrantes del grupo


#PRESENTACIONES:
### Fecha: (a determinar)
### Lugar: clase presencial (excepto el grupo que asiste a la clase de manera online)
### Formato: a eleccion de cada grupo, tanto lxs portavoces como la manera de presentar la informacion
