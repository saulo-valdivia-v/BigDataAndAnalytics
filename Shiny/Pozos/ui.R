                          ...
                          tabItems(
                              tabItem(tabName = "economico",
                                      fluidRow(
                                          ...
                                          fluidRow(
                                            tabBox(
                                              title = 'Producto',id = "tabset1", height = "100px",
                                              tabPanel("Oil", sliderInput('liftingBoe', 'Lifting_Oil', min =5, max =20 , value =0.10, step =0.5 )),
                                              tabPanel("Gas", sliderInput('liftingMMTU', 'Lifting_Gas', min=0, max = 5, value = 0.5, step = 0.1))
                                                  
                                              ),
                                            column(6,
                                                  dateInput('inicio',label = 'Periodo de Inicio de Produccion', min = 'ene-2000', max = 'dic-2050', format = "M-yyyy", language = 'es')
                                                  )
                                              ),
                                          ...
                                          column(3,
                                                 ...
                                                 box(width = 15, title = 'Resultados Economicos', solidHeader = TRUE, status = 'success',
                                                     column(
                                                         ...
                                                         br(),
                                                         box(
                                                           width = 15, title = 'REPAGO', solidHeader = TRUE, status = "primary",
                                                           verbatimTextOutput('calc5')
                                                         )
                                                     )#,
                                                     #column(
                                                    #     8,
